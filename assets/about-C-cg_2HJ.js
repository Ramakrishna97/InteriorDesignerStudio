import"./global-iaosacMP.js";import{c as t,a as o}from"./footer-tnfXZSx-.js";function a(){const e=document.getElementById("app");if(!e)return;e.innerHTML="",e.appendChild(t());const i=document.createElement("section");i.className="about-section";const n=document.createElement("div");n.className="content-container",n.innerHTML=`
    <h1>About Me</h1>
  ...
  `,i.appendChild(n),e.appendChild(i),e.appendChild(o())}a();
